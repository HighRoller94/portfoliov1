...
function Skills() {
    ...
    return (
        <div className="skills__row" data-scroll-section id="skills">
            <div className="skills__header" >
                <h1 data-aos="fade-right">Skills.</h1>
                <p data-aos="fade-right">Here are a few <span>things I've picked up</span> along the way.</p>
            </div>
            <div className="skills__container">
                <div className="skills__section" data-aos="fade-up" >
                    <svg className="skills__icon" xmlns="http://www.w3.org/2000/svg" width="108" height="108" viewBox="0 0 108 108">
                        <g id="Group_70" data-name="Group 70" transform="translate(-385 -3174)">
                            <g id="Ellipse_1" data-name="Ellipse 1" transform="translate(385 3174)" stroke="currentColor" strokeWidth="3">
                            ...
                            <g id="Icon_fea`t`her-code" data-name="Icon feather-code" transform="translate(22.418 14.59)">
                                <path id="Path_34" data-name="Path 34" d="M24,20.418l5.709-5.709L24,9" transform="translate(-3.464 -9)" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3"/>
                                <path id="Path_35" data-name="Path 35" d="M8.709,9,3,14.709l5.709,5.709" transform="translate(-3 -9)" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3"/>
                            </g>
                            <line id="Line_26" data-name="Line 26" x1="3.806" y2="19.665" transform="translate(33.837 10.332)" fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="4"/>
                            </g>
                        </g>
                    </svg>
                ...
                <div className="skills__section" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <g id="Group_72" data-name="Group 72" transform="translate(-866 -3134.915)">
                        <g id="Ellipse_2" data-name="Ellipse 2" transform="translate(866 3134.915)" stroke="currentColor" strokeWidth="3">
                        <circle cx="54" cy="54" r="54" stroke="none"/>
                        </g>
                ...
                <div className="skills__section" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <g id="Group_71" data-name="Group 71" transform="translate(-1387.323 -2941.636)">
                        ...
                        <g id="Ellipse_3" data-name="Ellipse 3" transform="translate(1387.323 2941.636)" stroke="currentColor" strokeWidth="3">
                            <circle cx="54" cy="54" r="54" stroke="none"/>
                        </g>
