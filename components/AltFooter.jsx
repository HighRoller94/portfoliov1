...
import AltFooterStyles from '../styles/components/AltFooter.module.scss'
...
function AltFooter() {
    ...
    return (
        <>
            <div className={AltFooterStyles.socials} >
                <a
                    className="link" href="https://www.linkedin.com/in/ash-bridges/" target="_blank" rel="noreferrer" >
                    <FaLinkedin className={AltFooterStyles.linkedIcon} />
                </a>
                <a
                    className="link" href="https://github.com/HighRoller94" target="_blank" rel="noreferrer" >
                    <ImGithub className={AltFooterStyles.gitIcon} />
                </a>
                <div className={AltFooterStyles.socialsTag}>
                    socials
                </div>
                <svg initial="hidden" animate="visible" xmlns="http://www.w3.org/2000/svg" width="2" height="190" viewBox="0 0 2 210">
                    <path id="Path_48" data-name="Path 48" d="M14904.395,1586.325V1356.831" transform="translate(-14903.395 -1356.831)" fill="currentColor" stroke="currentColor" strokeWidth="3" />
                </svg>
            </div>

            <div className={AltFooterStyles.footer}>
                <div className={AltFooterStyles.wrapper}>
                    <div className={AltFooterStyles.container}>
                        <div className={AltFooterStyles.definitelyNotWhoYouThink}></div>
                        <div className={AltFooterStyles.pills}>
                            <div className={AltFooterStyles.path}></div>
                            <div className={AltFooterStyles.path}></div>
                            <div className={AltFooterStyles.path}></div>
                            <div className={AltFooterStyles.path}></div>
                        </div>
                ...
                <div>
                    <svg id="Layer_1" className={AltFooterStyles.footerLogo} data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 251.01 229.13">
                ...
                <div className={AltFooterStyles.icons}>
                ...
                <div className={AltFooterStyles.copyright}>
